...
In companies, many ways exist to exchange information: emails, documents, coffee chats, company-wide meetings, ect. To make the problem tractable, let us focus on only one type of exchange, often used in feedback sessions or for problem-solving: the 1on1, a conversation between two people. Allowing only for 1on1s, full information exchange within a group means that each person has a 1on1 with all other members. The solution to this problem originates from an unexpected place: chess. 

The chess player Richard Schurig invented the [Round-Robin Tournament]([url](https://en.wikipedia.org/wiki/Round-robin_tournament)). The Round-Robin Tournament is a method to schedule 1on1s in a group without wait times. I found a curious application as co-organizer of kissing workshop at [Nowhere](www.goingnowhere.org), a festival. We used the Round-Robin Tournament to ensure that participants could explore the kissing techniques of all other participants without repeatitions and without wait times.

This blog-post is motivated by yet another application. In my last job, I was part of a growing team. To stay in-tune with each other, we had daily 15-min checkins. This worked when we were a team of three. But as we grew to 10, the checkins had degraded to context-free, ritualistic readings of our daily todos. We felt the breath of the 90 second on-screen timer in our necks. Organising the checkins as parallel 1on1s via a Round-robin tournament would certainly have improved our lot. With one 1on1 per day, you would have checked in with the remaining 9 colleagues within a 9 day-window. We felt that 3-person meetings were just as useful as 1on1, with the additional benefit that we would need fewer days to see all colleagues. So how to schedule 1on1on1s without incurring any wait times or repeatitions? 

In this blog, we'll start by reviewing the Round-Robin tournament. The following sections explain how to schedule 3-player games for groups of $n=9$ and $n=27$ people. My hunch is that solutions for any power of 3 exist but I haven't managed to find it.
